...
<head>
	...
	<body><center>
			...
			<div id="page">
				...
				<table width="70%">
				<form method="post">
					<tr><td colspan="2"> <font face="Courier new" size="4" color="Darkred"> <b><a href="home.html">Home</a> > Milk</b> <hr color="darkred"/></font></td></tr>
					<tr>
					...
					<tr>
						<td align="left">*Quantity:</td><td align="left"> <input type="text" name="milk_quantity" value="1" /></td>
					</tr>
					<tr>
						<td align="left">Rate:</td><td align="left"> <input type="text" name="milk_price" value="18" /></td>
					</tr>
					<tr>
						<td align="left">Remark:</td><td align="left"> <textarea rows="4" cols="50" name="remark">Paid</textarea> </td>
					</tr>
					<tr><td colspan="2" align="right"> <hr color="darkred"/> *(Quantity in packet, per packet contains 500ml./1 ltr.) <br/> <input type="submit" value="Save" /> </td></tr>
				</form>
				</table>
				<br/>
			</div>
			...
			<center>
				...
				<?php
					...
					$col2=$_POST['milk_quantity'];
					$amount=$_POST['milk_price'];
					$remark = $_POST['remark'];
