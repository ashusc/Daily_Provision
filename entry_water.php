...
<head>
	...
	<body><center>
			...
			<div id="page">
				...
				<table width="70%">
				<form method="post">
					<tr><td colspan="2"> <font face="Courier new" size="4" color="Darkred"> <b><a href="home.html">Home</a> > Water</b> <hr color="darkred"/></font></td></tr>
					<tr>
					...
					<tr>
						<td align="left">Quantity:</td><td align="left"> <input type="text" name="water_quantity" value="" /></td>
					</tr>
					<tr>
						<td align="left">Amount:</td><td align="left"> <input type="text" name="water_amount" value="" /></td>
					</tr>
					<tr>
