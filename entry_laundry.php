...
<head>
	...
	<body><center>
			...
			<div id="page">
				...
				<table width="70%">
				<form method="post">
					<tr><td colspan="2"> <font face="Courier new" size="4" color="Darkred"> <b><a href="home.html">Home</a> > Laundry</b> <hr color="darkred"/></font></td></tr>
					<tr>
					...
					<tr>
						<td align="left">Cloths:</td><td align="left"> <input type="text" name="laundry_quantity" value="" /></td>
					</tr>
					<tr>
						<td align="left">Total Amount:</td><td align="left"> <input type="text" name="laundry_amount" value="" /></td>
					</tr>
					<tr>
			...
			<center>
				...
				<?php
					...
					$col2=$_POST['laundry_quantity'];
					$amount=$_POST['laundry_amount'];
					$remark = $_POST['remark'];
