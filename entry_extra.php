...
<head>
	...
	<body><center>
			...
			<div id="page">
				...
				<table width="70%">
				<form method="post">
					<tr><td colspan="2"> <font face="Courier new" size="4" color="Darkred"> <b><a href="home.html">Home</a> > Extra</b> <hr color="darkred"/></font></td></tr>
					<tr>
					...
					<tr>
						<td align="left">Product:</td><td align="left"> <input type="text" name="extra_product" value="" /></td>
					</tr>
					<tr>
						<td align="left">Total Amount:</td><td align="left"> <input type="text" name="extra_amount" value="" /></td>
					</tr>
					<tr>
