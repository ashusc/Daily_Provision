...
<head>
	...
	<body><center>
			...
			<div id="page">
				<div id="line"></div>
				<table width="70%">
				<form method="post" id="transport">
					<tr><td colspan="2"> <font face="Courier new" size="4" color="Darkred"> <b><a href="home.html">Home</a> > Transportation</b> <hr color="darkred"/></font></td></tr>
					<tr>
						<td align="left">Date:</td><td align="left"> <input type="date" name="dated" value="this.today();" /></td>
					</tr>
					<tr>
						<td align="left">To/From:</td><td align="left"> <input type="text" name="to_from" value="" /></td>
					</tr>
					<tr>
						<td align="left">By (Vehicle):</td>
						<td align="left">
							<select name="transport_by" form="transport">
					...
					<tr>
						<td align="left">Total Amount:</td><td align="left"> <input type="text" name="transport_amount" value="" /></td>
					</tr>
					<tr>
			...
			<center>
				...
				<?php
					$categary="transportation";
					$dated = $_POST['dated'];
					$col1=$_POST['to_from'];
					$col2=$_POST['transport_by'];
					$amount=$_POST['transport_amount'];
					$remark = $_POST['remark'];
