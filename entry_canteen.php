<html>
	...
	<body><center>
			...
			<div id="page">
				...
				<table width="70%">
				<form method="post">
					<tr><td colspan="2"> <font face="Courier new" size="4" color="Darkred"> <b><a href="home.html">Home</a> > Canteen</b> <hr color="darkred"/></font></td></tr>
					<tr>
					...
					<tr>
						<td align="left">Food:</td><td align="left"> <input type="text" name="canteen_food" value="" /></td>
					</tr>
					<tr>
						<td align="left">Total:</td><td align="left"> <input type="text" name="canteen_total" value="" /></td>
					</tr>
					<tr>
			...
			<center>
				...
				<?php
					...
					$col2=$_POST['canteen_food'];
					$amount=$_POST['canteen_total'];
					$remark = $_POST['remark'];
