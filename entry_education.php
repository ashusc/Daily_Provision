...
<head>
	...
	<body><center>
			...
			<div id="page">
				...
				<table width="70%">
				<form method="post">
					<tr><td colspan="2"> <font face="Courier new" size="4" color="Darkred"> <b><a href="home.html">Home</a> > Education</b> <hr color="darkred"/></font></td></tr>
					<tr>
					...
					<tr>
						<td align="left">Product:</td><td align="left"> <input type="text" name="edu_product" value="" /></td>
					</tr>
					<tr>
						<td align="left">Total:</td><td align="left"> <input type="text" name="edu_total" value="" /></td>
					</tr>
					<tr>
			...
			<center>
				...
				<?php
					...
					$col2=$_POST['edu_product'];
					$amount=$_POST['edu_total'];
					$remark = $_POST['remark'];
